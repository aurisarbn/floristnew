...
if (isset($_POST['update_admin'])) {
   ...
   $update_u_birthdate = mysqli_real_escape_string($conn, $_POST['update_u_birthdate']);
         ...
         <div class="container mt-5">
            <form method="POST" action="#">
               <table class="table table-bordered">
                  ...
                  <tr>
                     <th>Tanggal Lahir</th>
                     <td><input type="date" class="form-control" value="<?php echo $fetch_admin['birthdate']; ?>" name="update_u_birthdate"></td>
                  </tr>
                  <tr>
                     <th>Email</th>
